...
const TechStack = () => {
  return (
    <div className='md:flex justify-center font-black mt-[650px] md:mt-10 md:ml-7 w-full md:w-auto flex-wrap'>
        <h1 className='mr-10 mt-1 mb-6 md:mb-0 text-center justify-center'>Tech Stack</h1>
